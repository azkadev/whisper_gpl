...
/// Created By Azkadev
///
class WhisperGplNativeLibraryByAzkadev {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  WhisperGplNativeLibraryByAzkadev(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  WhisperGplNativeLibraryByAzkadev.fromLookup(ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) lookup) : _lookup = lookup;
  ...
  void InitializedWhisperGplByAzkadevNativeCallbackFunction(
    ffi.Pointer<ffi.Void> callback,
  ) {
    return _InitializedWhisperGplByAzkadevNativeCallbackFunction(
      callback,
    );
  }

  late final _InitializedWhisperGplByAzkadevNativeCallbackFunctionPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>)>>('InitializedWhisperGplByAzkadevNativeCallbackFunction');
  late final _InitializedWhisperGplByAzkadevNativeCallbackFunction = _InitializedWhisperGplByAzkadevNativeCallbackFunctionPtr.asFunction<void Function(ffi.Pointer<ffi.Void>)>();

  ffi.Pointer<ffi.Char> InvokeWhisperGplByAzkadevNativeFunction(
    ffi.Pointer<ffi.Char> parameters,
  ) {
    return _InvokeWhisperGplByAzkadevNativeFunction(
      parameters,
    );
  }

  late final _InvokeWhisperGplByAzkadevNativeFunctionPtr = _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)>>('InvokeWhisperGplByAzkadevNativeFunction');
  late final _InvokeWhisperGplByAzkadevNativeFunction = _InvokeWhisperGplByAzkadevNativeFunctionPtr.asFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)>();
}
